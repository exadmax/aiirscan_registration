...
public final class j extends Dialog implements TextWatcher, View.OnClickListener {
        ...
        this.b.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            public final void onGlobalLayout() {
                if (createSoftInputView.isShown()) {
                    ...
                    int height = j.this.b.getHeight() - point2.y;
                    int height2 = j.this.b.getHeight() - point.y;
                    if (height2 != height + createSoftInputView.getHeight()) {
                        j.this.b.reportSoftInputIsVisible(true);
                    } else {
                        j.this.b.reportSoftInputIsVisible(false);
                    }
                    j.this.b.reportSoftInputArea(new Rect(point.x, point.y, createSoftInputView.getWidth(), height2));
                }
            }
        });
    ...
    public final View createSoftInputView() {
        ...
        AnonymousClass3 r1 = new EditText(this.a) {
            ...
            public final void onSelectionChanged(int i, int i2) {
                j.this.b.reportSoftInputSelection(i, i2 - i);
            }
