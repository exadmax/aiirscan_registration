...
public class UnityPlayer extends FrameLayout implements e {
            ...
            this.a = new Handler(new Handler.Callback() {
                ...
                public final boolean handleMessage(Message message) {
                    ...
                    if (dVar == d.NEXT_FRAME) {
                        ...
                        if (e.this.f >= 0) {
                            if (e.this.f == 0 && UnityPlayer.this.k()) {
                                UnityPlayer.this.a();
                            }
                            e.this.f--;
                        }
    ...
    public UnityPlayer(Context context) {
        ...
        if (currentActivity != null && k()) {
            this.m = new k(this.t, k.a.a()[getSplashMode()]);
            addView(this.m);
        }
        ...
        this.f.c(true);
        this.u = c();
        this.u.setContentDescription(a(context));
        addView(this.u);
                ...
                this.a.a(isFinishing() ? new Runnable() {
                    ...
                    public final void run() {
                        if (UnityPlayer.this.nativePause()) {
                            boolean unused = UnityPlayer.this.v = true;
                            UnityPlayer.this.g();
                            semaphore.release(2);
                            return;
                        }
    ...
    public void showSoftInput(String str, int i2, boolean z, boolean z2, boolean z3, boolean z4, String str2, int i3, boolean z5) {
        ...
        a((Runnable) new Runnable() {
            public final void run() {
                UnityPlayer unityPlayer = UnityPlayer.this;
                unityPlayer.b = new j(unityPlayer.t, this, str3, i4, z6, z7, z8, str4, i5, z10);
    ...
    public boolean showVideoPlayer(String str, int i2, int i3, int i4, boolean z, int i5, int i6) {
        ...
        boolean a2 = this.x.a(this.t, str, i2, i3, i4, z, (long) i5, (long) i6, new p.a() {
            public final void a() {
                p unused = UnityPlayer.this.x = null;
            }
        });
        if (a2) {
            a((Runnable) new Runnable() {
